...
export function StaffDetail({ name, role, bio = "Mais informações em breve.", photo = null }: Props) {
  return (
    <div className="min-h-screen bg-background">
      <Navbar />
      <main>
        <PageHeader eyebrow="Equipe" title={name} description={role} />
            ...
            <article className="grid gap-10 rounded-2xl border border-border bg-card p-8 shadow-card md:p-10 lg:grid-cols-[260px_1fr] lg:items-start">
              ...
              <div>
                ...
                <div className="mt-10 flex flex-wrap gap-3">
                  <a
                    href="mailto:contato@denisonleandro.adv.br"
